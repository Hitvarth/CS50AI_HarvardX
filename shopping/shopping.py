...
def load_data(filename):
	...
	def num_month(Month):
		mapping={ 'Jan':0, 'Feb':1, 'Mar':2, 'Apr':3, 'May':4, 'June':5, 'Jul':6, 'Aug':7, 'Sep':8, 'Oct':9, 'Nov':10, 'Dec':11}
...
def evaluate(labels, predictions):
	...
	sensitivity=positive_identified/positive
	specificity=negative_identified/negative
