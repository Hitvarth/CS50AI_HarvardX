...
def load_data(data_dir):
	...
	for category in range(NUM_CATEGORIES):
		for image_file in os.listdir(f"{data_dir}{os.sep}{category}"):
			img=cv2.imread(f"{data_dir}{os.sep}{category}{os.sep}{image_file}")
...
def get_model():
	...
	model.add(tf.keras.layers.Dense(NUM_CATEGORIES*4,activation='relu'))
